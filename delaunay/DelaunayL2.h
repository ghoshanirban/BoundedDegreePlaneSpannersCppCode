...
class DelaunayGraph {
  public:
                   ...
                   RandomAccessIterator pointsEnd )
    {
        ...
        BoundedDegreePlaneSpanners::spatialSort<K>(P, index);
...
void DelaunayL2Spanner(const Algorithms::input_t &in, Algorithms::output_t &out) {
