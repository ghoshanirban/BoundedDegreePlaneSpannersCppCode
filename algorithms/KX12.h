...
#ifndef LIBSPANNER_KX12_H
#define LIBSPANNER_KX12_H
...
namespace BoundedDegreePlaneSpanners {
    ...
    namespace kx2012 {
        ...
        bool selectEdge(//const DelaunayL2 &T,
            ...
            if (BoundedDegreePlaneSpanners::contains(E, edge_j_i)) { E[edge_j_i] = true; }
    ...
    void KX12(const Algorithms::input_t& in, Algorithms::output_t& out,
                bool printLog = false) {
        using namespace kx2012;
        using BoundedDegreePlaneSpanners::contains;
...
//            Timer tim;
                ...
                do {
                    if (!T.is_infinite(N)) {
                        if (BoundedDegreePlaneSpanners::contains(wideVertices, N)) {
                            ...
                            if (!BoundedDegreePlaneSpanners::contains(closestPointDistanceInCone, currentCone) ||
...
//            cout<<"c:";
//            Timer tim;
                while (!BoundedDegreePlaneSpanners::contains(wideVertices, N) && ++N != done);
                done = N;
                    ...
                    if (!T.is_infinite(N)) {
                        ...
                        if (BoundedDegreePlaneSpanners::contains(wideVertices, N)) {
                            ...
                            for (int conalEdgesToAdd = std::min(conalDifference - 1, 2);
                                ...
                                bool containsPreviousPoint = BoundedDegreePlaneSpanners::contains(E,
                                                                                                  std::make_pair(currentPointIndex,
                                                                                        previousPoint.second->info()));
                                bool containsN = BoundedDegreePlaneSpanners::contains(E,
