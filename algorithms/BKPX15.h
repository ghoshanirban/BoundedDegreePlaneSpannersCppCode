#ifndef LIBSPANNER_BKPX15_H
#define LIBSPANNER_BKPX15_H
...
//                    cout << endl << endl << "duplicate edge chain begins at " << source_id << endl;
    ...
    void BKPX15(const Algorithms::input_t &in, Algorithms::output_t &out) {
