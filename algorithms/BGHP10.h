#ifndef LIBSPANNER_BGHP10_H
#define LIBSPANNER_BGHP10_H
...
namespace BoundedDegreePlaneSpanners {
    ...
    namespace bghp2010 {
        ...
        inline number_t getCanonicalAngle(const index_t p, const index_t q, const index_t r, const Algorithms::input_t &P) {
...
//    //assert(e.first<H.size());
        ...
        void findKeyEdges(KeyEdgesMap &KeyEdges, DelaunayTD &D, const Algorithms::input_t &P) {
...
// Main algorithm.
    void BGHP10(const Algorithms::input_t& in, Algorithms::output_t& out,
                  bool printLog = false) {
